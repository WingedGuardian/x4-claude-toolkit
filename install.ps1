...
$X4CopyPrune = @('tools\x4validate\.venv',
                 ...
                 'tools\x4validate\.toolkit-usage-baseline.json',
                 'tools\x4validate\.hook-false-positive-baseline.json',
                 'tools\x4validate\.instrument-hygiene-baseline.json',
