...
corpus_sweep = import_gate("corpus_sweep")
...
def test_a_loader_failure_with_NO_output_is_a_crash():
...
def test_the_documented_exit_codes_are_NOT_crashes():
...
def test_an_undocumented_exit_code_is_a_crash_even_if_it_looks_harmless():
